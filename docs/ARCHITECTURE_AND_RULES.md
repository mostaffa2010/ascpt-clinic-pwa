...
- **الإصدار 1.4.27:** تحسين تجربة الموبايل لشيت المريض (إزالة الأزرار المزدحمة بالهيدر، محاذاة العنوان لليسار، توحيد أزرار الجلسات والخطاب التأميني) وإعادة هيكلة كروت إحصائيات الطبيب بنمط رأسي (Stacked Rows) لمنع الـ Text-wrap تماماً.