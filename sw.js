...
// Version: 1.4.0-beta.46 (Cache: ascpt-clinic-v1.4.0-beta.46)
// True Offline Navigation & Fault-Tolerant Cache Architecture
// ========================================================

const CACHE_NAME = 'ascpt-clinic-v1.4.0-beta.46';
...
const APP_SHELL_ASSETS = [
  ...
  '/index.html',
  '/manifest.json',
  '/css/style.css?v=1.4.0-beta.46',
  '/css/print.css?v=1.4.0-beta.46',
  '/icons/icon-192.png',
  '/icons/icon-512.png',
